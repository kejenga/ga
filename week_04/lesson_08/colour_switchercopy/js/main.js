...
//declare the function, and the two variables then define the variables
//then call the function each time and insert the variable
//essentially using a template multiple times